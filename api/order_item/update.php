...
if($jwt) {
    ...
    try {
        ...
        if (isset($data->product)) $order_item->item["product"] = $data->product;
        if (isset($data->brand)) $order_item->item["brand"] = $data->brand;
        if (isset($data->order)) $order_item->item["order"] = $data->order;
        if (isset($data->name)) $order_item->item["name"] = $data->name;
        if (isset($data->attr)) $order_item->item["attr"] = $data->attr;
        if (isset($data->link)) $order_item->item["link"] = $data->link;
        if (isset($data->top)) $order_item->item["top"] = $data->top;
        if (isset($data->price)) $order_item->item["price"] = $data->price;
        if (isset($data->count)) $order_item->item["count"] = $data->count;
        if (isset($data->total_fake)) $order_item->item["total_fake"] = $data->total_fake;
